...
export default function Location() {
  return (
    ...
    <div className="m-4"> 
      ...
      karaoke. On Monday, I had the opportunity to do a cooking class with the Chef who is head of our dining hall and
      learnt how to de-bone a chicken for the first time. On Tuesday I was able to attend a speed-meet with a group of high
